        ...
        <Modal
          ...
          <View style={jobs.modalBackground}>
            <View style={jobs.modalHeader}>
              ...
              <Text style={jobs.jobSubTitle1}>{selectedJob.company}</Text>
              <Text style={jobs.jobSubTitle2}>{selectedJob.location}</Text>
            </View>
            <ScrollView style={jobs.jobDesc}>
              <Text>{selectedJob.description}</Text>
            </ScrollView>
            <Button title="Add to favourites" onPress={onJobSave} />
          </View>
        </Modal>
      </View>
    </SafeAreaView>
